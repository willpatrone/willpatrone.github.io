...
---
## Science Olympiad
Science Olympiad (SciOly) is a 501 (c)(3) nonprofit dedicated to promoting K-12 STEM Education through team-based competitions. I joined the Executive Board of Science Olympiad at the University of Florida, a subsidiary of the main SciOly organization, in 2019. As an event coordinator, I was responsible for organizing the event coordinators who wrote the exams and oversaw lab and engineering events, including content review of exams, coordinating travel logistics, and working with the university to secure venues for each event for both the Northern Florida Regional and State tournament (the latter of which was cancelled due to COVID-19). I was subsequently promoted to President and tournament director in March 2020. For the next two and a half years, I was responsible for supervising the execution of these events. These tournaments brought over 1500 students and more than 150 volunteers together to make these events a success. Although I stepped away in August 2022, I still maintain an active role within the executive board as an emeritus member. Outside of my role as president, I created a trial event, AgriBio, to fill the gap in the Science Olympiad curriculum for an agricultural science event. As of today, AgriBio has been run at 29 tournaments across 11 states. I have also been selected as an event supervisor for countless tournaments around the country, including at MIT, Yale, and the University of Chicago. 
...
<img align="top" src="/assets/img/PoE Capstone Website Image.jpg" alt= "Individuals walk around an open lobby with many posters of scientific research on it, with students explaining their work" width="650"
     height="449" />
